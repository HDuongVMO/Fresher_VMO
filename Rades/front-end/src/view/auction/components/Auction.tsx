  ...
  return (
    ...
    >
      ...
      <VStack w="full" alignItems="flex-start">
        ...
        <HStack w="full">
          <Text color="rgba(255,255,255,0.6)" fontWeight="bold" fontSize="14px">Highest bid</Text>
          <Spacer />
          <Text color="rgba(255,255,255,0.8)" fontWeight="bold">{numberFormat(item.lastBid)} RADT</Text>
        </HStack>
      </VStack>     
